#include <Arduino.h>
#line 1 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
#line 1 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
//............................................................
...
#define SE_MUSIC_0  4
#define SE_DEAD     5
#define BEEP_BTN_OK_MELO 400
#define BEEP_BTN_NG_MELO 260
#define BEEP_BTN_LEN     100
#define BEEP_GYN_0_LEN   150
#line 49 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void mp3_play(uint8_t idx);
#line 110 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Save();
#line 143 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Load();
#line 179 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Clear();
#line 192 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void BtnDetectAll();
#line 207 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Sleep();
#line 216 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void DebugLEDFlash(uint8_t count, uint8_t length);
#line 225 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void SleepCatch();
#line 279 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void SceneInit();
#line 285 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool LifeCycle();
#line 337 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void InitAudio();
#line 347 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void InitIO();
#line 359 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void CheckFactorySign();
#line 371 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void WriteFactorySign();
#line 378 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void setup();
#line 393 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void loop();
#line 424 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Start();
#line 499 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Update();
#line 575 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Menu(uint8_t *timer);
#line 649 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void MenuLauncher();
#line 663 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Touch(uint8_t *timer);
#line 680 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void TouchLauncher();
#line 697 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Feed(uint8_t *timer, uint8_t timeLength);
#line 715 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void FeedLauncher();
#line 732 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Clean(uint8_t *timer, uint8_t timeLength);
#line 748 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void CleanLauncher();
#line 764 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Config(uint8_t *timer, uint8_t selectionCount, uint8_t *confNo, int8_t *mode);
#line 859 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void ConfigLauncher();
#line 877 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Garally(uint8_t *timer , uint8_t *imageNo);
#line 912 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void GarallyLauncher();
#line 927 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void CommunicationLauncher();
#line 985 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Mingame0(uint8_t countDown, uint8_t* loveCnt);
#line 1029 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void Mingame0Launcher();
#line 1071 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
bool Game(int countDown, int maxTime, uint8_t* loveCnt);
#line 1134 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void GameLauncher();
#line 49 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
void mp3_play(uint8_t idx){
  if(idx == SE_BTN_OK){
    tone(BEEP_PIN,BEEP_BTN_OK_MELO,BEEP_BTN_LEN);
    delay(BEEP_BTN_LEN);
  }else{
    tone(BEEP_PIN,2637,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
    tone(BEEP_PIN,2489,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
    tone(BEEP_PIN,2349,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
    tone(BEEP_PIN,2217,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
    tone(BEEP_PIN,2093,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
    ...
    tone(BEEP_PIN,2637,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
    tone(BEEP_PIN,2794,BEEP_GYN_0_LEN);
    delay(BEEP_GYN_0_LEN);
  }
}       
//............................................................
...
void CommunicationLauncher(){
  ...
  */
  screen.print("SORRY DISABLED", 2, 10);
  screen.print("ON THIS VARSION.", 2, 10);
}
