# 1 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
# 1 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
//............................................................
...
//............................................................
# 7 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 8 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
//#include <DFPlayer_Mini_Mp3.h>
# 10 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 11 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 12 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 13 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 14 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 15 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 16 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
# 17 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino" 2
//............................................................
//............................................................
//..................... HARDWARE PREPARE .....................
//............................................................
//............................................................
// LCD .......................................................
# 33 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
extern uint8_t SmallFont[];
GameLCD screen(84, 48, 504, 6, 5, 4, 2, 12);
//............................................................
// Audio .....................................................
//............................................................
# 49 "z:\\Project\\VoishoEmbedded2\\VoishoEmbedded2.ino"
...
void BtnDetectAll(){
  btnL = ButtonDetect(14, &BufL, Status);
  btnC = ButtonDetect(15, &BufC, Status);
  btnR = ButtonDetect(16, &BufR, Status);
  btnDownL = ButtonDetect(14, &BufL, DonwTrig);
  btnDownC = ButtonDetect(15, &BufC, DonwTrig);
  btnDownR = ButtonDetect(16, &BufR, DonwTrig);
  btnUpL = ButtonDetect(14, &BufL, UpTrig);
  btnUpC = ButtonDetect(15, &BufC, UpTrig);
  btnUpR = ButtonDetect(16, &BufR, UpTrig);
  BufL = btnL;
  BufC = btnC;
  BufR = btnR;
}
...
void Sleep(){
  ...
  wdt_enable(9); // After 1s Restart.
  do { (*(volatile uint8_t *)((0x33) + 0x20)) = (((*(volatile uint8_t *)((0x33) + 0x20)) & ~((1 << (1)) | (1 << (2)) | (1 << (3)))) | ((0x06<<1))); } while(0);
  do { do { (*(volatile uint8_t *)((0x33) + 0x20)) |= (uint8_t)(1 << (0)); } while(0); do { __asm__ __volatile__ ( "sleep" "\n\t" :: ); } while(0); do { (*(volatile uint8_t *)((0x33) + 0x20)) &= (uint8_t)(~(1 << (0))); } while(0); } while (0); // System go down.
}
  ...
  if(Life>0){
    if((uint16_t)Frame-PreFrame > LifeInterval) { // Interval is about 10s.
      ...
      if(Life == 0){
        ...
        if(random(0, 3)==0){
          if(Hungery < 100)Hungery += 3 /* 1 .. 9*/;
          randomSeed(Frame%11 + analogRead(5)%74);
          if(Dirty<2 && random(0, 10/10 /* 1 .. 10*/)==0) Dirty++;
          //DebugLEDFlash(4, 150);
        }
        // Event
        randomSeed(Frame + analogRead(5)%81);
        if(Hungery>10 && Dirty>1 && random(0, 10/3 /* 1 .. 10*/)==0){
          Sick = 1;
          //DebugLEDFlash(4, 150);
        }
        // Damage
...
bool LifeCycle(){
  ...
  if((uint16_t)Frame-PreFrame > LifeInterval) { // Interval is about 10s.
    if(Life == 0){
      ...
      if(Hungery>10 && Dirty>1 && random(0, 10/3 /* 1 .. 10*/)==0) Sick = 1;
      // Damage
      if(Hungery==100 || Sick==1){
        if(Life>0)Life--;
        if(Love>0)Love--;
...
void Start(){
  ...
  selectionIcons = new GameObject(&screen, selectionsIconTex, 8, 0, 6, 10);
  ...
  selectionsText = new GameObject(&screen, selectionsTextTex, 8, 0, 6, 30);
  // FEED
