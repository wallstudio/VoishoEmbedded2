...
* PCをハッキング（したように見える）機能があります．（これはゆかクラゲの一次の設定です）実際にPCの操作権限を無制限に奪取することや，人間やデータに害を成す機能は搭載されていません．しかしながら意図せぬバグや環境によっては正しく動かないばあいや変更を加えてしまう可能性がありますので重要なデータのバックアップなどは怠らないようにしてください．
